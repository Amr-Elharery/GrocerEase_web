            ...
            <div className="overflow-x-auto">
              <table className="w-full table-fixed text-start">
                <thead>
                  ...
                  <th className="w-[120px] px-2.5 py-2.5 whitespace-nowrap">{t("submissions:table.submissionId")}</th>                    <th className="w-[175px] px-2.5 py-2.5">{t("submissions:table.productName")}</th>
                    <th className="w-[115px] px-2.5 py-2.5">{t("submissions:table.category")}</th>
                    <th className="w-[135px] px-2.5 py-2.5">{t("submissions:table.submitter")}</th>
                    <th className="w-[95px] px-2.5 py-2.5">{t("submissions:table.date")}</th>
                    <th className="w-[100px] px-2.5 py-2.5">{t("submissions:table.status")}</th>
                    <th className="w-[85px] px-2.5 py-2.5 text-end">
