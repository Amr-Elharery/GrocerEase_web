...
export default function Navbar({ variant = "auth", onLogout }) {
  return (
    <header className="h-16 bg-white border-b border-border flex items-center justify-between px-6 relative z-50">
      ...
      {/* Brand */}
      <Link to="/auth" className="flex items-center gap-2 no-underline">
      ...
      {variant === "app" && (
        <nav className="flex items-center gap-6">
          <Link to="/app/home"      className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Home</Link>
          <div className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Inventory</div>
          <div   className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Orders</div>
          <div    className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Reports</div>
        </nav>
      )}
